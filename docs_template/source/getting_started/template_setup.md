...
search for `"super_memory"` and replace it with a concise version of your project's
name. Importantly, you also need to rename the folder `src/super_memory` to
